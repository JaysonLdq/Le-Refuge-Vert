 ...
 */
final class Version20250209230001 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE logement (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(150) NOT NULL, surface INT NOT NULL, image_path VARCHAR(255) NOT NULL, nb_personne INT NOT NULL, emplacement INT NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tarif (id INT AUTO_INCREMENT NOT NULL, logement_id INT NOT NULL, saison_id INT NOT NULL, price INT NOT NULL, INDEX IDX_E7189C958ABF955 (logement_id), INDEX IDX_E7189C9F965414C (saison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tarif ADD CONSTRAINT FK_E7189C958ABF955 FOREIGN KEY (logement_id) REFERENCES logement (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tarif DROP FOREIGN KEY FK_E7189C958ABF955');
